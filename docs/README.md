...
| 文档 | 说明 |
|------|------|
| [project-context.md](project-context.md) | ⭐ **AI 智能体关键规则** (95+ 实现规则) |
| [supabase-auth-setup.md](supabase-auth-setup.md) | Supabase 认证配置和故障排除 |
| [github-oauth-flow.md](github-oauth-flow.md) | GitHub OAuth 登录完整流程图 |
...
### 核心功能
1. **表单创建** - 拖拽式构建器 (@dnd-kit)，支持 10 种题型
...
| v2.2 | 2026-02-10 | 添加 GitHub OAuth 登录流程文档；更新 project-context 规则至 95+ |
